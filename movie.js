...
"use strict";
/* WEBPACK VAR INJECTION */(function(module) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mithril__ = __webpack_require__(0);
...
module.exports = {
  view(vnode) {
    return __WEBPACK_IMPORTED_MODULE_0_mithril___default()('div#container.grid',
			__WEBPACK_IMPORTED_MODULE_0_mithril___default()('div.row',
				__WEBPACK_IMPORTED_MODULE_0_mithril___default()('div.col c12#banner',
					__WEBPACK_IMPORTED_MODULE_0_mithril___default()('img[src=movies.png]')
				)
			),
      __WEBPACK_IMPORTED_MODULE_0_mithril___default()('div.col c12',
        __WEBPACK_IMPORTED_MODULE_0_mithril___default()('nav.nav',
          __WEBPACK_IMPORTED_MODULE_0_mithril___default()('a.pagename current[href="/"]', {
            oncreate: __WEBPACK_IMPORTED_MODULE_0_mithril___default.a.route.link,
            onclick: function() {this.blur()}
          }, "Home"),
          __WEBPACK_IMPORTED_MODULE_0_mithril___default()('a[href="/new/"]', {
            oncreate: __WEBPACK_IMPORTED_MODULE_0_mithril___default.a.route.link,
            onclick: function() {this.blur()}
          }, "Nieuw")
      ),
        __WEBPACK_IMPORTED_MODULE_0_mithril___default()('section', vnode.children)
      )
    )
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mithril___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_mithril__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__layout__ = __webpack_require__(3);
// import stuff
...
__WEBPACK_IMPORTED_MODULE_0_mithril___default.a.route(document.body, "/", {
  "/": {
    render() {
      return __WEBPACK_IMPORTED_MODULE_0_mithril___default()(__WEBPACK_IMPORTED_MODULE_1__layout__["default"], __WEBPACK_IMPORTED_MODULE_0_mithril___default()(MovieList))
    }
/*  },
  "/new/": {
    render() {
      return m(Layout, m(MovieNew))
    }
  },
  "/edit/:id": {
    render(vnode) {
